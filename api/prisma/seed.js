...
await client.query(`
      INSERT INTO exhibit (exhibit_id, exhibition_id, badge_id, title, description, status_id) VALUES
  ...
  `);
    ...
    await client.query(`
      ...
      (1, NULL, 1, 'Cover for Through the Lens of Time', '', '/images/1763374361266-257005579-ThroughTheLensOfTime.jpg', true),
      (2, NULL, 2, 'Cover for The Beginning', '', '/images/1763374415129-951739919-TheBeginning.jpg', true),
      ...
      (5, 3, NULL, 'relentlesssabotage2.jpg', '', '/images/1763374619656-995830117-relentlesssabotage2.jpg', true),
      (6, 4, NULL, 'divingintotheunknown.jpg', '', '/images/1763374665097-492743414-divingintotheunknown.jpg', true);
    `);
