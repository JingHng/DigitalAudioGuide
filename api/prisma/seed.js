...
await client.query(`
   ...
   await client.query(`
    ...
    (1, 'Enter The Sandbox', 'We have witnessed Singapore''s journey to nationhood... Leave your unique imprint on our present and future here in the Sandbox today.', '/images/badge/Enter_The_Sandbox.png'),
    (2, 'Particles of Change', 'Immerse in an experience where play meets inspiration.', '/images/badge/Particles_of_Change.png'),
    (3, 'Strength of Our Nation', 'The peace we experience in Singapore today is in no small part due to our men and women in uniform...', '/images/badge/Strength_of_Our_Nation.png'),
    (4, 'Staying Resilient Amid Tough Times', 'Singaporeans have shown resilience amid challenges...', '/images/badge/Staying_Resilient_Amid_Tough_Times.png'),
    (5, 'Special Badge Number 5', 'Malaysians have shown resilience amid challenges...', '/images/badge/Staying_Resilient_Amid_Tough_Times.png'),
    (6, 'School of Computing Explorer', 'Scan here to discover the exciting world of computing at Singapore Polytechnic!', '/images/badge/Our_Milestones.png'),
    (7, 'SP Counselling Guide', 'Learn about course counselling and find your perfect program at Singapore Polytechnic.', '/images/badge/Relentless_Sabotage.png'),
    (8, 'SP Counselling CLS', 'Learn about course counselling and find your perfect program at Singapore Polytechnic.', '/images/badge/Relentless_Sabotage.png'),
    (9, 'SP Counselling SOB', 'Learn about course counselling and find your perfect program at Singapore Polytechnic.', '/images/badge/Relentless_Sabotage.png')

`);

    // Insert exhibits from seed data (exhibit_ids 1, 2, 3, 4, 5, 6)
await client.query(`
      INSERT INTO exhibit (exhibit_id, exhibition_id, badge_id, title, description, additional_description, status_id) VALUES
      (1, 1, 1, 'Maritime Roots Interactive Gallery', 'This exhibit recreates early Singapore as a bustling maritime hub. Visitors walk through a curved projection wall showing trading ships arriving from the region, bustling markets, and cultural exchanges. Interactive hotspots allow visitors to tap on historical objects—such as spices, pottery, and navigational tools—to learn how these items shaped Singapore''s early importance in regional trade.', 'Dive deeper into Singapore''s maritime heritage through immersive storytelling. This gallery features authentic artifacts recovered from archaeological sites, including ancient coins, ceramics, and navigation instruments. Advanced augmented reality stations let visitors virtually handle historical trading goods and understand their significance in Southeast Asian commerce. The exhibit showcases how Singapore''s strategic location attracted merchants from China, India, the Malay world, and beyond, creating the multicultural foundation that defines Singapore today.', 1),
