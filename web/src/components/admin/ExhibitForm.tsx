      ...
      <form onSubmit={handleSubmit} className="exhibit-internal-form">
        ...
        <div className="form-section-card">
          ...
          <div className="exhibit-media-box">
            ...
            <div className="file-upload-controls">
              ...
              {primaryImageFile && <span className="file-status-text">{primaryImageFile.name}</span>}
            </div>
          </div>
        </div>
        ...
        <div className="exhibit-form-footer">
          ...
          <button type="submit" className="exhibit-btn-save" disabled={loading}>
            {loading ? <Loader2 className="animate-spin" size={18} /> : <><CheckCircle2 size={18} /> Save Exhibit</>}
          </button>
        </div>
      </form>
    </motion.div>
